...
function EditPost() {
  ...
  useEffect(() => {
    const getPost = async () => {
      try {
        const responce = await axios.get(`${process.env.REACT_APP_BASE_URL}/posts/${id}`)
    ...
    <section className="create-post">
      <div className="container">
        ...
        <form className="form create-post__form" onSubmit={editPost}>
          <input type="text" placeholder='Titile' value={title} onChange={e => setTitle(e.target.value)} autoFocus />
